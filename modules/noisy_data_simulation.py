...
class NoisyLabelSimulation:
    def __init__(self, n_samples=1000, n_features=15, noise_rate_positive=None, noise_rate_negative=None, correlation=0.8, seed=None):
        """
    ...
    def generate_data(self):
        ...
        if self.noise_rate_positive is not None and self.noise_rate_negative is not None:
            # Separate noise rates for positive and negative classes
